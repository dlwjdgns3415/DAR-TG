...
def get_args():
    ...
    parser.add_argument('--snapshot', type=str, default="/home/aah18155qt/DTG-Lunet/results/hnavsnapshot.pth_250918_epoch30_Unet.tar", help='snapshot')
    ...
    parser.add_argument('--diffusion_model', type=int, default=0, help="0: rnn; 1: unet; 2: lightM-unet")
    ...
    parser.add_argument('--diffusion_time_steps', type=int, default=10, help="")
...
def get_configuration():
    ...
    elif args.diffusion_model == 2:
        cfg.model.diffusion.model_type = DiffusionModelType.lightm_unet
    else:
